...
// 운세 카테고리(옛 "fortune:{slug}")는 CategoryReadingSection + /api/fortune/[slug]/reading의
// 자체 reserveReadingSlot으로 넘어가면서 이 카탈로그를 안 거치게 됐다 - 지금은 saju-summary/free뿐.
export type PurchaseProductId = "saju-summary" | "free";
