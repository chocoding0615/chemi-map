...
// 오행별 여우상 설명 뱅크 — lib/result-engine/foxType.ts가 seed로 하나씩 골라 쓴다.
export const FOX_TYPE_DESCRIPTIONS: Record<ElementKey, string[]> = {
  ...
  earth: [
    "달빛처럼 은은하게 곁을 지켜주는 여우예요. 화려하게 나서진 않지만, 힘든 날일수록 옆에 있으면 마음이 편안해지는 존재예요.",
    "고요하고 안정적인 기운을 가진 여우예요. 겉으론 잔잔해 보여도 속으론 은근히 세심하게 다 챙기고 있어요.",
  ],
  metal: [
