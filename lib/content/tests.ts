...
const GWAMOIP_RESULTS: TestResultType[] = [
  {
    ...
    maxScore: 19,
    description: [
      "세상이 불바다가 됐다. 드라마 결말 유출, 폭발한 단톡방, 사고 친 지인. 모두 소리치는데 당신은 조용히 팝콘을 집는다.",
      "“그래서 다음 화 언제 나옴?” 이게 당신의 리액션 전부다. 남들이 파도에 휩쓸릴 때 당신은 옥상에서 내려다본다. 그 시야 덕에 아무도 못 본 걸 본다.",
      "다만 문득 생각할 때가 있다. 나도 한번 진짜로 미쳐보면 어떨까. 결론은 매번 같다. 내일 하자, 오늘은 여기까지.",
    ],
  ...
  },
  {
    ...
    maxScore: 29,
    description: [
      "당신에겐 비밀 스위치가 있다. 평소엔 누구보다 느긋하다가, 마음에 드는 걸 발견한 순간 딸깍 — 눈을 떠보니 새벽 3시, 47화.",
      "주변 사람은 당신이 몰입하는 줄도 모른다. 말이 없으니까. 하지만 당신 안에서는 이미 대서양 파도가 치고 있다.",
      "스위치를 끌 줄 아는 건 재능이다. 대신 한 달에 한 번은 고의로 안 끄고 밤새워봐라. 그날의 피곤함이 인생에서 제일 달콤하다.",
    ],
  ...
  },
  {
    ...
    maxScore: 39,
    description: [
      "재미를 발견한 순간 이미 두 번째 에피소드가 재생 중이다. 당신에게 천천히 즐기기란 일종의 모욕이다.",
      "친구가 아직 못 봤다고 할 때 당신은 조금 슬프다. 스포일러 때문이 아니라, 그 사람이 늦었다는 사실에.",
      "덕분에 당신 주변엔 항상 최신화가 돈다. 당신은 걸어 다니는 리뷰 위성이다. 가끔은 멈춰 서서 명장면을 다시 보는 것도 잊지 마세요.",
    ],
  ...
  },
  {
    ...
    maxScore: 48,
    description: [
      "새벽 4시 17분, 당신은 검색창에 입력한다. 그 드라마 3화 엑스트라 여배우 실명. 알고리즘이 포기한 구석까지 파고드는 당신에게 경의를 표한다.",
      "당신의 취미는 취미가 아니라 라이프스타일이며 천직이며 때로는 부업이다. 팬덤 문법, 세계관 설정집, 필모그래피 — 머릿속에는 이미 아카이브가 있다.",
      "위키도 정주행 영상도, 세상은 당신 같은 사람으로 돌아간다. 당신의 과몰입은 결함이 아니라 공공재다. 오늘도 지식의 등대, 수고했어요.",
    ],
...
const LOVE_RESULTS: TestResultType[] = [
  {
    ...
    maxScore: 19,
    description: [
      "잘 가던 연인이 우리 요즘 좀 별래라고 말하면, 당신은 속으로 이렇게 생각한다. 어? 난 괜찮았는데.",
      "당신의 사랑은 합체가 아니라 나란히 걷기다. 손은 잡되, 다른 한 손은 호주머니에 두고 싶은 타입. 그 여백이 당신의 산소다.",
      "다만 기억할 것 — 상대의 산소는 함께 숨쉬는 시간일 수도 있다. 가끔은 여백 없이 꽉 안아주자. 상대는 놀라겠지만, 나쁘지 않을 거다.",
    ],
  ...
  },
  {
    ...
    maxScore: 29,
    description: [
      "3년 전 상대가 좋아했다던 디저트집 이름을 당신은 아직 기억한다. 본인은 왜 기억하는지 모르겠지만. 그런 게 당신이다.",
      "당신의 사랑은 불꽃놀이가 아니라 난롯불이다. 첫날밤엔 심심해 보여도, 겨울밤에 제일 먼저 찾게 되는 건 결국 이 불씨다.",
      "표현이 서툰 게 죄는 아니다. 다만 마음은 쌓아두면 적립금이지 사랑이 아니다. 일주일에 한 번, 좋다는 말을 깨서 소비해라. 재고는 안 줄어든다.",
    ],
  ...
  },
  {
    ...
    maxScore: 39,
    description: [
      "답장이 올라오는 순간 심박수가 경기를 뛰는 선수처럼 치솟는다. 당신에게 설렘은 감정이 아니라 스포츠다.",
      "기록 갱신, 최고조, 그리고 끝나고 나서의 허탈함. 다음 경기가 기다려지는 프로다.",
      "당신 덕에 연애가 즐거운 사람이 많다. 공은 인정. 다만 장기전은 설렘이 아니라 편안함에서 이긴다는 것 — 사실 그 비밀을 제일 먼저 아는 것도 당신이다.",
    ],
  ...
  },
  {
    ...
    maxScore: 48,
    description: [
      "당신이 사랑에 빠지면 지구 자전이 빨라진다는 소문이 있다. 미확인이지만, 검색창에 그 사람 이름이 열두 개 저장된 건 확인됐다.",
      "굿모닝 메시지, 점심 리마인드, 저녁 유머, 자기 전 장문 — 당신의 애정은 예약 작업처럼 돌고, 상대가 잠든 새벽에도 당신 마음은 출근해 있다.",
      "광공은 사랑의 재생에너지다. 단 하나의 경고 — 태양에 너무 가까이 가면 상대가 녹는다. 가끔은 지구 궤도에서 따스하게 비춰줘도 충분하다.",
    ],
...
const PHONE_RESULTS: TestResultType[] = [
  {
    ...
    maxScore: 19,
    description: [
      "친구가 물었다. 너 폰 어디 뒀어? 당신은 가방 안쪽 주머니를 조용히 가리켰고, 친구는 경외했다.",
      "당신에게 알림은 종소리가 아니라 노크다. 필요하면 열고, 아니면 무시한다. 이 시대에 그걸 해내는 사람은 현자다.",
      "참고로 당신의 스크린타임 스크린샷은 SNS에서 화제가 될 수 있다. 다만 그걸 올리는 행위 자체가… 아니, 그만두자. 수행은 계속하라.",
    ],
  ...
  },
  {
    ...
    maxScore: 29,
    description: [
      "출근길 스크롤, 점심 짧은 영상, 그리고 — 정신을 차려보면 폰을 내려놓고 있는 당신. 그 내려놓는 힘이 이 시대 제일 귀한 자원이다.",
      "무한 스크롤 늪도 안다. 피곤한 날엔 당신도 빠진다. 다음 날 거울 보며 또 그랬네라고 중얼거리는 것까지 포함해서.",
      "디지털과 현실 사이 줄타기 10년차 베테랑. 이대로도 좋지만 한 달에 하룻밤은 충전기에서 떼어놓고 자자.",
    ],
  ...
  },
  {
    ...
    maxScore: 39,
    description: [
      "새 소식은 언론보다 당신이 먼저 안다. 지진이 나면 당신 폰이 먼저 흔들린다는 우스갯소리가 있을 정도다.",
      "당신의 손가락은 뇌보다 빠르다. 뇌가 그냥 자자라고 하면 손가락이 5분만이라고 답한다. 그리고 그 5분은 어김없이 90분이 된다.",
      "당신 덕에 친구들은 트렌드를 안 놓친다. 공은 인정한다. 대신 목을 살펴주자. 목은 당신과 가장 오래된 동료다.",
    ],
  ...
  },
  {
    ...
    maxScore: 48,
    description: [
      "수면 6시간, 현실 활동 4시간, 화면 속 생활 14시간. 숫자가 안 맞는다면 그건 현실 쪽 통계가 잘못된 거다.",
      "밖에 나가면 뭐가 좋은데?라는 질문에 당신은 진지하게 답한다. 햇빛은 강렬하고 공기는 답답하고 와이파이는 없고. 결론은 화질 구지. 인정한다.",
      "그래도 비밀 하나 — 노을이 예쁜 날, 사진 말고 눈으로 담고 싶었던 적 있잖아. 그 감각이 원본 화질이다. 주 1회 정도 현실 스트리밍, 어때?",
    ],
